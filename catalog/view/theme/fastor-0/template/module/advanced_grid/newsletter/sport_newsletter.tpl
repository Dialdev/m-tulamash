...
<div class="sport-newsletter clearfix" id="newsletter<?php echo $id; ?>">
     <div class="heading">
          <p><?php echo $module['content']['title']; ?></p>
     </div>
     
     <div class="content-newsletter"><?php echo $module['content']['text']; ?></div>
	...
	<?php if($theme_options->get( 'rodo_status' ) == '1') { ?>
		<div class="newsletter_rodo5 white_rodo">
