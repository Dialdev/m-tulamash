...
<div class="newsletter bakery-newsletter clearfix row" id="newsletter<?php echo $id; ?>">
     <div class="col-sm-3">
          <div class="heading">
               <img src="image/catalog/bakery/icon-newsletter.png" alt="Newsletter">
               <h6><?php echo $module['content']['title']; ?></h6>
          </div>
     </div>
