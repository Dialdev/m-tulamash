    ...
    <tbody>
      <?php foreach ($fields as $field) { ?>
        <tr>
          ...
          <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php foreach ($field['values'] as $value) { ?><?php echo $value; ?><?php } ?></td>
        </tr>
      <?php } ?>
    </tbody>
  </table>
