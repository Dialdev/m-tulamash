  			...
  			<div class="row" id="quickview_product">
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     ...
			     <div class="price">
			        ...
			        <?php } ?>
			        <?php if (!$special) { ?>
			        <span class="price-new"><span itemprop="price" id="price-old"><?php echo ($price=='0р.') ? 'Цены уточняйте' : $price; ?></span></span>
			        <?php } else { ?>
			     ...
			     <div id="product">
			      ...
			      <?/*<div class="cart">
			        ...
			        <?php } ?>
			      </div>*/?><button id="smcup-float-button-4" class="btn2 btn-primary " onclick="getOCwizardModal_smcup(4, 1)">Заказать товар</button>
			     </div><!-- End #product -->
