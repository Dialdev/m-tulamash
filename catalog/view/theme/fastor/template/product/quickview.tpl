...
<head>
     ...
     echo $theme_options->compressorCodeCss( $config->get( 'config_template' ), $lista_plikow, 0, HTTP_SERVER ); 
     ...
     $lista_plikow[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/js/jquery.elevateZoom-3.0.3.min.js';
     ...
     echo $theme_options->compressorCodeJs( $config->get( 'config_template' ), $lista_plikow, 0, HTTP_SERVER ); ?>
  			...
  			<div class="row" id="quickview_product">
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     ...
			     <?/* <?php if ($price) { ?>
			      <div class="price">
			        <?php if (!$special) { ?>
			        <span class="price-new"><span itemprop="price" id="price-old">11111<?php echo $price; ?></span></span>
			        <?php } else { ?>
			     ...
			     <div id="product">
			      ...
			      <div class="cart clearfix"><button id="smcup-float-button-4" class="btn2 btn-primary " onclick="getOCwizardModal_smcup(4, 1)">Заказать товар</button>
