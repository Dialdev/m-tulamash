...
<div class="military-newsletter clearfix" id="newsletter<?php echo $id; ?>">
     <div class="left">
          <div class="heading"><?php echo $module['content']['title']; ?></div>
...
<?php if($theme_options->get( 'rodo_status' ) == '1') { ?>
	<div class="newsletter_rodo white_rodo">
