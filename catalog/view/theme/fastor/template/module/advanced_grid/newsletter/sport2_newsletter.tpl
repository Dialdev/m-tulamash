...
<div class="newsletter glamshop-newsletter sport2-newsletter clearfix row" id="newsletter<?php echo $id; ?>">
     <div class="col-sm-4">
          <div class="heading">
               <img src="image/catalog/sport2/icon-newsletter.png" alt="Newsletter">
