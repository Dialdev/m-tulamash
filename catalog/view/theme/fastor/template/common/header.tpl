...
<head>
	...
	// Spacing 20px
	if($theme_options->get( 'spacing_between_columns' ) == 2) $lista_plikow[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/css/spacing_20.css';
    ...
    if($theme_options->get( 'display_specials_countdown' ) == '1') {
         ...
         if(isset($countdown[$language_id])) {
         	$lista_plikow[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/js/countdown/' . $countdown[$language_id];
         } else {
         	$lista_plikow[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/js/countdown/jquery.countdown.min.js';
         }
    }
