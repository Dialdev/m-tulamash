...
class ControllerModuleCookie extends Controller {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/cookie.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/cookie.tpl', $data);
		} else {
			return $this->load->view('default/template/module/cookie.tpl', $data);
		}
	}
