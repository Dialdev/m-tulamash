...
class ControllerModuleXDZvonok extends Controller {
	...
	public function index() {
		$this->load->language('module/xd_zvonok');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/xd_zvonok', 'token=' . $this->session->data['token'], 'SSL')
		);
		$data['action'] = $this->url->link('module/xd_zvonok', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/xd_zvonok.tpl', $data));
	}
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/xd_zvonok')) {
