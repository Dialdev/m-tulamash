	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=module/fastor&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
							...
							<div class="section">
                                ...
                                <div class="section-content">
                                    <div class="input">
                                        ...
                                        <a href="http://fastortheme.com/" class="hint-tooltip" data-toggle="tooltip" title="Go to the documentation to se how it works" target="_blank"></a>
                                        <div class="clear"></div>
                                    </div>
...
<!--                                            
						...
						<div id="tab_rodo" class="tab-content">
					         <div class="input with-status">
					             ...
					             <?php if($rodo_status == 0) { echo '<div class="status status-off" title="0" rel="rodo_status"></div>'; } else { echo '<div class="status status-on" title="1" rel="rodo_status"></div>'; } ?>
					             <input name="rodo_status" value="<?php echo $rodo_status; ?>" id="rodo_status" type="hidden" />
					             <div class="clear"></div>
					         </div>
                                ...
                                <div class="section-content">
									...
									<?php foreach ($languages as $language) { ?>
	                                    ...
	                                    <div class="rodo-textarea">		
	                                    	<img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />						
	                                        <?php if(isset($rodo_text[$language_id])) { ?>
	                                            <textarea rows="0" cols="0" name="rodo_text[<?php echo $language_id; ?>]" id="rodo_text_<?php echo $language_id; ?>"><?php if($rodo_text[$language_id] != '') { ?><?php echo $rodo_text[$language_id]; ?><?php } else { ?>I agree <a href="#" target="_blank"><b>terms and conditions</b></a> and <a href="#" target="_blank"><b>Privacy Policy</b></a>.<?php } ?></textarea>
	                                        <?php } else { ?>
	                                            <textarea rows="0" cols="0" name="rodo_text[<?php echo $language_id; ?>]" id="rodo_text_<?php echo $language_id; ?>">I agree <a href="#" target="_blank"><b>terms and conditions</b></a> and <a href="#" target="_blank"><b>Privacy Policy</b></a>.</textarea>
	                                        <?php } ?>
	                                    </div>
                                    <?php } ?>
					...
					<div id="tab_install_data" class="tab-content">
                        ...
                        <div class="section">
                            <p style="font-family:Open Sans;color:#4c4c4c;font-size:12px;line-height: 21px;padding-top: 12px">Our theme is MultiStore ready and you can install sample data for each store with some restrictions. Demo content for modules: <b>âAdvanded Gridâ</b> and <b>âCustom Moduleâ</b> is added as new module on the list. Demo content for other module is replaced. If you have already <b>âMegaMenuâ</b> craeted and you install new demo content for this module, the old one will be replaced.<br><br>If you want to make your shop look exactly like our demo. Install sample data.</p>
