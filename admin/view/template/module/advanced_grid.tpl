						   			...
						   			<div id="module_<?php echo $module_row; ?>_column_<?php echo $columns_count; ?>_modules" class="tabs_add_element clearfix">
                                        ...
                                        <?php if(isset($column['module'])) { $s = 1; foreach($column['module'] as $column_module) { ?>
						   	          ...
						   	          <?php foreach ($languages as $language) { ?>
						   	              				<a href="#tab-language-html-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-<?php echo $s; ?>-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
						   	          <?php } ?>
						   	            				</div>
						   	          ...
						   	          <?php foreach ($languages as $language) { ?>
						   	              				<a href="#tab-language-box-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-<?php echo $s; ?>-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
						   	          <?php } ?>
						   	            				</div>
						   	          ...
						   	          <?php foreach ($languages as $language) { ?>
						   	          						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][links][title][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($column_module['links']['title'][$language_id])) echo $column_module['links']['title'][$language_id]; ?>" <?php if($column_module['type'] != 'links') echo 'disabled="disabled"'; ?>></div>
						   	          <?php } ?>
						   	          					</div>
						   	          				</div>
						   	                  ...
						   	                  if(isset($products_tabs_templates[$template])) {
						   	                       ...
						   	                       <?php $i++; }
						   	           				...
						   	           				<div class="input clearfix">
						   	           					...
						   	           					<div class="list-language">
						   	           <?php foreach ($languages as $language) { ?>
						   	           						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products_tabs][title][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($column_module['products_tabs']['title'][$language_id])) echo $column_module['products_tabs']['title'][$language_id]; ?>" <?php if($column_module['type'] != 'products_tabs') echo 'disabled="disabled"'; ?>></div>
						   	           <?php } ?>
						   	           					</div>
						   	           				</div>
						   	              				...
						   	              				<div class="input clearfix">
						   	              					...
						   	              					<div class="list-language">
						   	              <?php foreach ($languages as $language) { ?>
						   	              						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products_tabs][description][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($column_module['products_tabs']['description'][$language_id])) echo $column_module['products_tabs']['description'][$language_id]; ?>" <?php if($column_module['type'] != 'products_tabs') echo 'disabled="disabled"'; ?>></div>
						   	              <?php } ?>
						   	              					</div>
						   	              				</div>
						   	          ...
						   	          <?php foreach ($languages as $language) { ?>
						   	              				<a href="#tab-language-newsletter-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-<?php echo $s; ?>-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
						   	          <?php } ?>
						   	            			</div>
						   	               ...
						   	               if(isset($latest_blogs_templates[$template])) {
						   	                    ...
						   	                    <?php $i++; }
						   	          				...
						   	          				<div class="input clearfix">
						   	          					...
						   	          					<div class="list-language">
						   	          <?php foreach ($languages as $language) { ?>
						   	          						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][latest_blogs][title][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($column_module['latest_blogs']['title'][$language_id])) echo $column_module['latest_blogs']['title'][$language_id]; ?>" <?php if($column_module['type'] != 'latest_blogs') echo 'disabled="disabled"'; ?>></div>
						   	          <?php } ?>
						   	          					</div>
						   	          				</div>
...
function addLink(module_row, column, modules) {
	...
	html += '				<img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />';
...
function addModuleToColumn(module_row, column) {
	...
	<?php foreach ($languages as $language) { ?>
	html += '    				<a href="#tab-language-html-'+ module_row + '-' + column +'-' + modules + '-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>';
	<?php } ?>
	html += '  				</div>';
	...
	<?php foreach ($languages as $language) { ?>
	html += '    				<a href="#tab-language-box-'+ module_row + '-' + column +'-' + modules + '-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>';
	<?php } ?>
	html += '  				</div>';
	...
	<?php foreach ($languages as $language) { ?>
	html += '						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][links][title][<?php echo $language['language_id']; ?>]" value=""></div>';
	<?php } ?>
	html += '					</div>';
	html += '				</div>';
	...
	html += '					<div class="list-language">';
	<?php foreach ($languages as $language) { ?>
	html += '						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][products][title][<?php echo $language['language_id']; ?>]" value=""></div>';
	<?php } ?>
	html += '					</div>';
	html += '				</div>';
	...
	html += '					<div class="list-language">';
	<?php foreach ($languages as $language) { ?>
	html += '						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][products_tabs][title][<?php echo $language['language_id']; ?>]" value=""></div>';
	<?php } ?>
	html += '					</div>';
	html += '				</div>';
	...
	html += '					<div class="list-language">';
	<?php foreach ($languages as $language) { ?>
	html += '						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][products_tabs][description][<?php echo $language['language_id']; ?>]" value=""></div>';
	<?php } ?>
	html += '					</div>';
	html += '				</div>';
	...
	<?php foreach ($languages as $language) { ?>
	html += '    				<a href="#tab-language-newsletter-'+ module_row + '-' + column +'-' + modules + '-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>';
	<?php } ?>
	html += '  			</div>';
	...
	html += '					<div class="list-language">';
	<?php foreach ($languages as $language) { ?>
	html += '						<div class="language"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][latest_blogs][title][<?php echo $language['language_id']; ?>]" value=""></div>';
	<?php } ?>
	html += '					</div>';
	html += '				</div>';
