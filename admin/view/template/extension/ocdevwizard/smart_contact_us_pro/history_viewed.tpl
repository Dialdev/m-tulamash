...
<?php if ($histories) { ?>
  <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
      <li><a onclick="delete_all(1,'record');"><?php echo $button_delete_all; ?></a></li>
      <li><a onclick="delete_all_selected(1,'record');"><?php echo $button_delete_selected; ?></a></li>
    </ul>
  </div>
<?php } ?>
<button type="button" onclick="$('a[href=#viewed-saved-record-block]').click();" class="btn btn-primary"><i class="fa fa-refresh"></i> <?php echo $button_update; ?></button>
    ...
    <?php if ($histories) { ?>
      ...
      <tr>
        ...
        <td class="text-left">
          ...
          <?php if ($history['date_viewed'] != '0000-00-00 00:00:00') { ?>
          <p><strong><?php echo $text_date_viewed; ?></strong> <?php echo $history['date_viewed']; ?></p>
          <?php } ?>
        </td>
        <td class="text-left"><?php echo $history['status']; ?></td>
        <td class="text-center">
          <a onclick="confirm('<?php echo $text_are_you_sure; ?>') ? delete_selected(1,'record',<?php echo $history['record_id']; ?>) : false;" data-toggle="tooltip" title="" class="btn btn-warning" data-original-title="<?php echo $button_delete; ?>"><i class="fa fa-trash-o"></i></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
